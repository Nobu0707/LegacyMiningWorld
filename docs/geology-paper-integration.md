...
Phase 2Bは5種類の地中岩石までである。鉱石はPhase 3、Multiverse-Core統合・大量chunk性能試験はPhase 4で扱う。Phase 2Bの依存、plugin descriptor、Paper smoke、release JARにMultiverse-Coreは含まれない。
