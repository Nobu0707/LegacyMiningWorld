...
- 4チャンクの完全走査を大量chunk試験とは呼ばない。大量生成、MCA/NBT級走査、distribution、performance、clean regeneration、release candidateはPhase 4Bへ分離する。

## 後続で確定する事項

- Phase 4B: 大量chunk、大規模禁止block走査、distribution、性能、clean再生成一致、release candidate。
