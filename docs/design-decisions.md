...
- stable昇格は利用者受入・長時間試験・ライセンス決定後の別Phaseとする。今回はtag、push、publishを行わない。

## 後続で確定する事項

- Phase 5: user acceptance、long-running validation、license、stable `1.0.0`、optional tag/publish。
