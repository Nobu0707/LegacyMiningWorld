...
Phase 3BはMultiverse-Coreへ依存せず、server/plugins/multiverse-core-5.7.2.jarをPaper smokeへコピーしない。Phase 4でMultiverse generator列挙/world作成、大量chunk、禁止block完全走査、分布、性能、再生成一致、release candidate化を行う。
